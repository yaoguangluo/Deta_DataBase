...
##### 已完善功能：所有数据格式通过restcall的准备全部走gzip，功能已经是现在在另外一个项目中：https://github.com/yaoguangluo/Deta_VPCS_Frontend/blob/master/DetaSrc/org/deta/boot/vpc/vision/RestMapVision.java
