...
##### 已完善功能：update 的 nest join 函数 功能作者：罗瑶光2019-01-28 采用离散数学的conjunction 地摩根迭代化简进行多join表的选择条件区分。2019-01-28
##### 已完善功能：固定变量名称编程规范整体整理。动态集合先搁置。罗瑶光2019-01-29
##### 已完善功能：语音媒体文件的发送。 罗瑶光2019-01-29
##### 已完善功能：套接字阅读格式规范。 罗瑶光2019-01-29
##### 已完善功能：tcp 协议 header格式规范。 罗瑶光2019-01-29
##### 已完善功能：select where in 函数。罗瑶光2019-01-29
##### 已完善功能：select where !in 函数。罗瑶光2019-01-29
##### 已完善功能：日志管理系统的VPCS定义。罗瑶光2019-01-29
##### 已完善功能：plsql日志binlog 记录定义。罗瑶光2019-01-30
